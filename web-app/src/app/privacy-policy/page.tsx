...
const SECTIONS = [
  {
    title: '1. 信息收集 · Information We Collect',
    body: [
  ...
  {
    title: '4. 数据保留与删除 · Retention & Deletion',
    body: [
  ...
  {
    title: '6. 儿童与敏感数据 · Minors & Sensitive Data',
    body: [
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#fffaf0] via-white to-white pb-24">
      <section className="section pt-20">
        <div className="section-inner max-w-3xl text-[#1f2937]">
          ...
          <h1 className="mt-3 text-3xl font-extrabold">隐私政策 · Privacy Policy</h1>
