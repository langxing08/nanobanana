...
const CLAUSES = [
  ...
  {
    title: '2. 账户与安全 · Accounts & Security',
    items: [
  ...
  {
    title: '5. 内容使用与限制 · Content Usage & Restrictions',
    items: [
    ...
    <main className="min-h-screen bg-gradient-to-b from-[#fffaf0] via-white to-white pb-24">
      <section className="section pt-20">
        <div className="section-inner max-w-3xl text-[#1f2937]">
          ...
          <h1 className="mt-3 text-3xl font-extrabold">服务条款 · Terms of Service</h1>
